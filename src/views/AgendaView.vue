<template>
  <main class="relative">
        ...
        <div class="max-w-6xl mx-auto mt-8 md:mt-20 mb-10 px-4 lg:px-0"> <h2 class="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Dive Sites - Fujairah</h2>
        ...
        <div class="flex flex-col md:flex-row">
            <div class="md:mr-6 md:w-1/2">
                <h2 class="text-2xl md:text-3xl font-bold mb-4">Fujairah Sea</h2>
                <p class="mb-2 md:mb-4 text-sm md:text-lg">
                    It is a part of Gulf of Oman. 
                </p>
                <p>
                    <ul class="list-disc list-inside text-sm md:text-lg mb-2 md:mb-4">
                        <li>Around 1400 Square Kilometers area</li>
                        <li>Till 20 KM far from coaster area</li>
                        <li>Depth : </li>
						<li>Largest Port in the world</li>
                    </ul>
                </p>
            </div>
          
            <div class="md:mr-2 lg:mr-6 md:w-1/2">
                <img class="rounded-md md:rounded-lg md:mt-2" src="/images/marine.png" />
				<p class="mb-2 md:mb-4 text-sm md:text-lg" >
					Fujairah Emirate and Its Marine Area  
                </p>
